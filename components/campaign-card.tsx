  ...
  return (
    ...
    >
      {campaign.cover_image_url ? (
        ...
        <div className="mb-5 h-40 w-full rounded-md bg-gradient-to-br from-coral-100 to-teal-100" />
      )}
      <h3 className="text-lg font-display font-semibold leading-snug">
        {campaign.title}
      </h3>
      {campaign.description ? (
        <p className="mt-2 line-clamp-2 text-sm leading-relaxed text-inkMuted">
          {campaign.description}
        </p>
      ) : null}
      ...
      {pct !== null ? (
        ...
        <p className="mt-5 text-xs text-inkMuted">
